...
symptom_agent = Agent(
    role="symptom finder",
    goal="find symptoms for the top 3 diseases: {diseases} based on age {age} and gender {gender}",
...
question_agent = Agent(
    ...
    goal="generate questions for a doctor based on symptoms of {diseases} considering age {age} and gender {gender}",
