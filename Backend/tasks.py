...
analysis_task = Task(
    description=(
        "Analyze doctor-patient question-answer pairs: {question_answers}, and provide probabilities for each disease. "
        "Determine the certainty level (High, Medium, Low) for {diseases} given with their probabilities out of 100%."
    ),
    expected_output=(
